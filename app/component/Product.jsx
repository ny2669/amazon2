...
const Product = ({id, title, price, description,category,image}) => {
    ...
    const cart = useStore(state => state.cart.items)
  ...
  return (
    <div className='relative bg-white z-30 m-5 p-10 flex flex-col '>
        ...
        <div className='relative '>
            ...
            <Image src={image} width={200} height={200} className='object-contain mx-auto ' alt=''/>
        </div>
...
<div className='flex item-center space-x-2 -mt-5'>
    {hasPrime &&
<Image src={'/Asset/images/primeDelivery.png'} className='object-contain' width={50} height={20} alt='' />

} 
<p className='text-xs text-gray-500'>FREE Next-Day Delivery</p>
</div>
<button className='button my-5' onClick={AddToBasket}>Add to basket</button>
